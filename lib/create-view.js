...
exports.execute = function (params, appPath, options) {
    ...
    if (namespace) {
        ...
        if (!fs.existsSync(nvwPath + '/_layout.' + projectdata.engine)) {
            ...
            fs.writeFileSync(nvwPath + '/_layout.' + projectdata.engine, ejs.render(fs.readFileSync(coreView + '/_layout.' + projectdata.engine, 'utf8'), vloc), 'utf8');
            fs.writeFileSync(nvwPath + '/login.' + projectdata.engine, ejs.render(fs.readFileSync(coreView + '/login.' + projectdata.engine, 'utf8'), vloc), 'utf8');
            fs.writeFileSync(nvwPath + '/_messages.' + projectdata.engine, ejs.render(fs.readFileSync(coreView + '/_messages.' + projectdata.engine, 'utf8'), vloc), 'utf8');
            fs.writeFileSync(nvwPath + '/_footer.' + projectdata.engine, ejs.render(fs.readFileSync(coreView + '/_footer.' + projectdata.engine, 'utf8'), vloc), 'utf8');
            fs.writeFileSync(nvwPath + '/_header.' + projectdata.engine, ejs.render(fs.readFileSync(coreView + '/_header.' + projectdata.engine, 'utf8'), vloc), 'utf8');
            wrench.copyDirSyncRecursive(templater.getTemplatesDir() + '/errors', nvwPath + '/errors');
            fs.writeFileSync(nvwPath + '/_layout.' + projectdata.engine, ejs.render(fs.readFileSync(nvwPath + '/_layout.' + projectdata.engine, 'utf8'), vloc), 'utf8');
            try {
    ...
    // getTemplate
    // console.log(projectdata.engine)
