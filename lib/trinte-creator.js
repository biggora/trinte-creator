 ...
 **/
exports.showHelp = function showHelp(appLauncher) {
    ...
    if (fs.existsSync(helpFile)) {
        var ret = exports.readAndRenderEjs(helpFile, appLauncher);
        logger.notice(ret);
    } else {
 ...
 * @param {Object} data
 **/
exports.readAndRenderEjs = function readAndRenderEjs(source, data) {
