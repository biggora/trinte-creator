...
exports.translator = function translator() {
    return function (req, res, next) {
        ...
        var tran = function (key, defaultValue) {
            var substitute, translation, language;
            ...
            if (typeof global.__lc === 'object') {
                language = sess.language || config.language || 'en';
                translation = global.__lc[language];
            ...
            translation = translation ? translation : (defaultValue || key);
            return translation;
        };
