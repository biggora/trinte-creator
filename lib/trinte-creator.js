...
exports.buildAppStructure = function buildAppStructure(appLauncher, callback) {
    ...
    process.nextTick(function () {
        fs.writeFileSync(targetViews + '/_layout' + viewEngine.extension, parser.render(fs.readFileSync(coreView + '/frontend/_layout' + viewEngine.extension, 'utf8'), vloc), 'utf8');
        fs.writeFileSync(targetViews + '/_header' + viewEngine.extension, parser.render(fs.readFileSync(coreView + '/frontend/_header' + viewEngine.extension, 'utf8'), vloc), 'utf8');
        fs.writeFileSync(targetViews + '/_footer' + viewEngine.extension, parser.render(fs.readFileSync(coreView + '/frontend/_footer' + viewEngine.extension, 'utf8'), vloc), 'utf8');
        fs.writeFileSync(targetViews + '/_messages' + viewEngine.extension, parser.render(fs.readFileSync(coreView + '/frontend/_messages' + viewEngine.extension, 'utf8'), vloc), 'utf8');
        fs.writeFileSync(targetViews + '/login' + viewEngine.extension, parser.render(fs.readFileSync(coreView + '/frontend/login' + viewEngine.extension, 'utf8'), vloc), 'utf8');
    });
