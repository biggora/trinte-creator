...
exports.buildAppStructure = function buildAppStructure(appLauncher, callback) {
    ...
    exports.createDir(rootPath + '/app/views/errors');
    exports.copyFiles(viewEngine.getTemplatesDir() + '/errors', rootPath + '/app/views/errors', new RegExp('.' + viewEngine.extension + "$"));
