...
exports.execute = function (params, appPath, options) {
    ...
    // Render the views
    var retIndex = ejs.render(tmpIndex, { fields: fields, modelName: modelName, controllerName: controllerName, open: "<?", close: "?>" }, {delimiter: '?'});
    var retEdit = ejs.render(tmpEdit, { fields: fields, modelName: modelName, controllerName: controllerName, open: "<?", close: "?>" }, {delimiter: '?'});
    var retNew = ejs.render(tmpNew, { fields: fields, modelName: modelName, controllerName: controllerName, open: "<?", close: "?>" }, {delimiter: '?'});
    var retShow = ejs.render(tmpShow, { fields: fields, modelName: modelName, controllerName: controllerName, open: "<?", close: "?>" }, {delimiter: '?'});
    var retForm = ejs.render(tmpForm, { fields: fields, modelName: modelName, controllerName: controllerName, open: "<?", close: "?>" }, {delimiter: '?'});
